...
In our provided testcases, we only 
Give the test file:
...
Here the output should be "11: malloc
                           ...
                           14: foo
                           15: plus, minus"
Note that the analysis do not need to be context-sensitive. Hence the exit of function foo can return to both callsites (line 12 and 14), resulting
the points-to sets of t1 at both line 13 and 15  be {plus,minus}
